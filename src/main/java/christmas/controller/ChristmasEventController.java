...
public class ChristmasEventController {
    ...
    public void run() {
        ...
        ChristmasEvent christmasEvent = new ChristmasEvent(menus);
        int originalPrice = christmasEvent.calculateBeforeEventPrice();
        christmasEvent.buildEventMap(originalPrice, day);

        OutputView.printAllMenus(christmasEvent.getMenuMap());
